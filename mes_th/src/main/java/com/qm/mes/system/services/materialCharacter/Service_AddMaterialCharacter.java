 ...
 * 
 */
package com.qm.mes.system.services.materialCharacter;
...
import com.qm.mes.system.factory.IMaterialCharacterFactory;

/**
 * @author 于丽达
 * 
 */
public class Service_AddMaterialCharacter extends AdapterService {
	// 获得连接
	...
	public ExecuteResult doAdapterService(IMessage message, String processid)
		...
		try {
			...
			try {
				...
				IMaterialCharacter type = factory.createElement();
