 ...
 * 
 */
package com.qm.mes.system.services.materialidentify;
...
import com.qm.mes.system.factory.IMaterialidentifyFactory;

/**
 * @author 于丽达
 * 
 */
public class Service_AddMaterialidentify extends AdapterService {
	// 获得连接
	...
	public ExecuteResult doAdapterService(IMessage message, String processid)
		...
		try {
			...
			try {
				...
				IMaterialidentify identify = factory.createElement();
				identify.setName(message.getUserParameterValue("element_name"));
