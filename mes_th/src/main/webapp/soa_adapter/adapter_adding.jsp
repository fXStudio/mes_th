...
<script>
<!-- 
alert("参数为空");window.location.href='adapter_add.jsp';
 -->
</script>
<%
	return;
...
<script>
<!-- 
alert("数据来源参数不是数字");window.location.href='adapter_add.jsp';
 -->
</script>
<%
	return;
...
<script>
<!-- 
alert("流程号参数不是数字");window.location.href='adapter_add.jsp';
 -->
</script>
<%
	return;
...
<script>
<!-- 
alert("操作成功！");window.location.href='adapter_manage.jsp?page=<%=intpage%>';
 -->
</script>
<%
			} else {
...
<script>
<!-- 
alert("操作失败！原因不明！请与管理员联系！");window.location.href='adapter_manage.jsp?page=<%=intpage%>';
 -->
</script>
<%
		} else {
...
<script>
<!-- 
alert("操作失败！<%=se.getDescr()%>");window.location.href='adapter_manage.jsp?page=<%=intpage%>';
 -->
</script>
<%
		}
...
<script>
<!--  
alert("发生异常！<%=e.toString()%>");window.location.href='adapter_manage.jsp?page=<%=intpage%>';
-->
</script>
<%
	throw e;
