...
<%
	...
	//System.out.println("1***mobile_log*");
	//获取登录日期
...
<!-- 
     alert("参数为空!");window.location.href='mobile.jsp';
 -->
</script>
<%
		return;
...
<script language="JavaScript">
<!-- 
     alert("连接失效！");window.location.href='mobile.jsp';
 -->
</script>
<%
			return;
		...
		if(ac.userProof(username,password))
		{
			...
			//System.out.println("2***mobile_log*");
			String url="mobile_log4.jsp?year="+year+"&month="+month+"&day="+day;
...
<script language="JavaScript">
<!-- 
     alert("<%=message%>");window.location.href='mobile.jsp';
 -->
</script>
<%
			return;
