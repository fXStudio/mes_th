...
<script>
<!-- 
alert("参数为空");window.location.href='process_statement_input.jsp';
 -->
</script>
<%
	return;
...
<script>
<!-- 
alert("操作成功！");window.location.href='process_statement_view.jsp?page=<%=intpage%>';
 -->
</script>
<%
			} else {
...
<script>
<!-- 
alert("操作失败！原因不明！请与管理员联系！");window.location.href='process_statement_view.jsp?page=<%=intpage%>';
 -->
</script>
<%
		} else {
