...
<script>
<!-- 
alert("参数为空");window.location.href='materialCharacter_insert.jsp';
 -->
</script>
<%
		return;
...
<script>
<!-- 
alert("参数值最多40个字符,每汉字占2个字符");window.location.href='materialCharacter_insert.jsp';
 -->
</script>
<%
		return;
...
<script>
<!-- 
alert("参数名已经存在,请重新输入!");window.location.href='materialCharacter_insert.jsp';
 -->
</script>
		<%
			return;
...
<%
		...
		//调用soa中的流程 暂时设为1 
		//todo "53"在流程定义表中是"添加物料特征"
		stmt.close();
		er=bus.doProcess("53", message);
%>
<%
		//释放资源
...
<script>
<!-- 
alert("操作成功！");window.location.href='materialCharacter_insert.jsp';
 -->
</script>
<%
		}
...
<script>
<!-- 
alert("操作失败！原因不明！请与管理员联系！");window.location.href='materialCharacter_insert.jsp';
 -->
</script>
<%
			}
...
<script>
<!-- 
alert('操作失败！<%=se.getDescr().replaceAll("\n","")%>');window.location.href='materialCharacter_insert.jsp';
 -->
</script>
<%
			}
