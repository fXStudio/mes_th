...
<html>
    ...
    <body>
        <div class="title"><strong><!-- InstanceBeginEditable name="标题2" -->IE FIT 导入<!-- InstanceEndEditable --></strong></div>
        <div align="center">
            ...
            <div class="div_normal">注：<span class="div_red">上传文件格式应为Excel <a href="template.xls" style="color:blue;">(模板)</a></span><br></div>
        </div>
    </body>
    <script type="text/javascript" language="javascript">
       <!--
           ...
           function check(form_obj){
               ...
               var regex = /.*\.xls[x]?$/i;// 判断文件类型是否为excel
