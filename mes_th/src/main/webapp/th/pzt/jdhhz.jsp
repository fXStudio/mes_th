...
<html>
    ...
    <link rel="stylesheet" type="text/css" href="../../cssfile/css.css">
		<script type="text/javascript"
			src="../../JarResource/META-INF/tag/taglib_common.js"></script>
			 <base href="<%=basePath%>">
    <title>捷达/宝莱/高尔夫线配货单后滑轴打印</title>
  ...
  <body>
      ...
      <div align="center">
      <font size="+4" >捷达/宝莱/高尔夫线配货单后滑轴打印</font>
      </div>
   ...
   <div id="d">
  <APPLET ID="JrPrt" name = "app" codebase="th/pzt" CODE = "JdhhzApplet"  
...
{ 
    ...
    var ch=document.getElementById("ch").value;
    if(ls=="2"){
       document.app.pp(rq,ch,1);
       window.setTimeout("test(2)",10000);
    }
    if(ls=="4"){
       document.app.pp(rq,ch,1);
       for(var i=2;i<5;i++){
       window.setTimeout("test("+i+")",10000);
       }
    }
     if(ls=="8"){
       document.app.pp(rq,ch,1);
