...
<% 
     ...
     try{
         ...
         StringBuilder strSql = new StringBuilder("SELECT ID, CCARNO, CSEQNO, WUPTIME, DABEGIN FROM CARDATA");
         
         if(rad != null && !"".equals(rad.trim())){
             if("row_time".equalsIgnoreCase(rad)){
                 if(startDate != null && !"".equals(startDate)){
                     strSql.append(" where datediff(minute, DABEGIN, '");
                 ...
                 if(endDate != null && !"".equals(endDate)){
                     ...
                     strSql.append(" datediff(minute, DABEGIN, '");
         ...
         if(PageCount > 0){
             ...
             while(record_count < PageSize && !rs.isAfterLast()){
                ...
                ca.setWuptime(rs.getInt("WUPTIME"));// 总装上线次数
                ca.setDwbegin(rs.getString("DABEGIN"));// 总装上线时间
...
<html>
    ...
    <body>
        <div align="center">
            <div class="title"><strong><!-- InstanceBeginEditable name="标题" -->总装重复上线查询<!-- InstanceEndEditable --></strong></div>
            ...
            <mes:table reSourceURL="../../../JarResource/" id="qulity_states">
                <mes:thead>
                    <mes:tr>
                        ...
                        <mes:td width="160">总装顺序号</mes:td>
                        <mes:td width="120">总装上线次数</mes:td>
                ...
                <mes:tfoot>
                   <mes:tr>
                     <mes:td colspan="100%" align="center">
                         <form id="tform" name="form" style="margin: 0px"  method="post" onSubmit="return checkinput(this)" action="zongzhuang_search.jsp">
