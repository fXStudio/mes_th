...
<script>
<!-- 
alert("参数为空");window.location.href='materialidentify_update.jsp';
 -->
</script>
<%
		return;
...
<script>
<!-- 
alert("参数值最多40个字符,每汉字占2个字符");window.location.href='materialidentify_view.jsp';
 -->
</script>
<%
		return;
...
<script>
<!-- 
alert("操作失败！原因不明！请与管理员联系！");window.location.href='materialidentify_view.jsp';
 -->
</script>
<%
			}
