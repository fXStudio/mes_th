...
<html>
  ...
  <body>
  <%
  final Log log = LogFactory.getLog("mobile_log4.jsp");
...
<div align=center style="display:none;">	
	...
	<FORM name="tform" METHOD=POST ACTION="mobile_log4.jsp">
		...
		<%
			...
			try{
				...
				*/
				if(rs.next()){
					response.sendRedirect("mobile_log4.jsp?roleno="+rs.getObject(1)+"&rolename="+rs.getString(4));
					return;
				}else{
					session.removeAttribute("userid");
					response.sendRedirect("mobile_log4.jsp");
				}
  ...
  %>
	...
	<script language="JavaScript">
		<!-- 
    	 alert("请从新登陆");window.location.href='mobile.jsp';
 		-->
	</script>
