Ext.ux.ItemSelector = Ext.extend(Ext.form.Field, {
			...
			msHeight : 300,
 			hideNavIcons : false,
			imagePath : "",
			// 我把向上，向下，置顶，置底功能都屏蔽了，请在整理代码时，不要将up2.gif,down2.gif,top2.gif,bottom2.gif等图片删除
			// iconUp:"up2.gif",
			// iconDown:"down2.gif",
			iconLeft : "mep/user/images/left2.gif",
			iconRight : "mep/user/images/right2.gif",
			// iconTop:"top2.gif",
			...
			onRender : function(ct, position) {
				Ext.ux.ItemSelector.superclass.onRender
				...
				this.toMultiselect.on('dblclick', this.onRowDblClick1, this);
			...
			onRowDblClick1 : function(vw, index, node, e) {
