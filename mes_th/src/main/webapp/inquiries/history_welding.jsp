...
<html>
	...
	<%   
    final  Log log = LogFactory.getLog("history_welding.jsp");
	...
	try{
	    ...
	    switch(radio_value){
			...
			list_part = factory_ws.getHistoryPartsByStartTimeEndTime(condition_One,condition_Two,ss.getCcarType(),searchsetid,con);
			sql_part = dao.getHistoryPartsByStartTimeEndTime(condition_One,condition_Two,ss.getCcarType(),searchsetid);
			list_ws = factory_ws.getHistoryStatByStartTimeEndTime(condition_One,condition_Two,ss.getCcarType(),searchsetid,con);
			sql_ws = dao.getHistoryStatByStartTimeEndTime(condition_One,condition_Two,ss.getCcarType(),searchsetid);
			...
			list_part = factory_ws.getHistoryPartsByStartOrderEndOrder(condition_One,condition_Two,ss.getCcarType(),searchsetid,con);
			sql_part = dao.getHistoryPartsByStartOrderEndOrder(condition_One,condition_Two,ss.getCcarType(),searchsetid);
			list_ws = factory_ws.getHistoryStatByStartOrderEndOrder(condition_One,condition_Two,ss.getCcarType(),searchsetid,con);
			sql_ws = dao.getHistoryStatByStartOrderEndOrder(condition_One,condition_Two,ss.getCcarType(),searchsetid);
			...
			list_part = factory_ws.getHistoryPartsByStartTimeNum(condition_One,condition_Two,ss.getCcarType(),searchsetid,con);
			sql_part = dao.getHistoryPartsByStartTimeNum(condition_One,condition_Two,ss.getCcarType(),searchsetid);
			list_ws = factory_ws.getHistoryStatByStartTimeNum(condition_One,condition_Two,ss.getCcarType(),searchsetid,con);
			sql_ws = dao.getHistoryStatByStartTimeNum(condition_One,condition_Two,ss.getCcarType(),searchsetid);
			sql_temp3 = "where cx.dWBegin>=convert(varchar(100),'" + condition_One + "',20) ";
	    ...
	    ||radio_value==3&&request.getParameter("d13").equals("")&&request.getParameter("num").equals("")){
	    	list_part = factory_ws.getHistoryParts(ss.getCcarType(),searchsetid,con);
	    	sql_part = dao.getHistoryParts(ss.getCcarType(),searchsetid);
	    	list_ws = factory_ws.getHistoryStat(ss.getCcarType(),searchsetid,con);
			sql_ws = dao.getHistoryStat(ss.getCcarType(),searchsetid);
...
.head2 {
	...
	<body background="../images/background.jpg">
		...
		<div align="center">
			...
			<form action="history_welding.jsp">
				<table>
					<tr>
						<td>
