...
<%  
    final  Log log = LogFactory.getLog("car_select.jsp");
	...
	try{
		...
		list_as = factory_ws.getpart(sql_temp1,con);
...
<div class="title"><strong><!-- InstanceBeginEditable name="标题2" -->单车查询<!-- InstanceEndEditable --></strong></div>
  ...
  <table border="0" cellspacing="0" cellpadding="0" width="1090">
  	...
  	<td align="center" width="95">总装顺序号</td>
  	...
  	<td align="center" width="115">焊装报文名称</td>
  	<td align="center" width="115">总装报文名称</td>
  	</tr>
