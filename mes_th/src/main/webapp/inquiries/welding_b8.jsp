...
<html>
	...
	try{
	    ...
	    switch(radio_value){
			...
			list_part = factory_ws.getPartsByStartTimeEndTime_B8Q5(condition_One,condition_Two,ss.getCcarType(),"02",con);
			sql_part = dao.getPartsByStartTimeEndTime_B8Q5(condition_One,condition_Two,ss.getCcarType(),"02");
			list_ws = factory_ws.getStatByStartTimeEndTime_B8Q5(condition_One,condition_Two,ss.getCcarType(),"02",con);
			sql_ws = dao.getStatByStartTimeEndTime_B8Q5(condition_One,condition_Two,ss.getCcarType(),"02");
			...
			list_part = factory_ws.getPartsByStartOrderEndOrder_B8Q5(condition_One,condition_Two,ss.getCcarType(),"02",con);
			sql_part = dao.getPartsByStartOrderEndOrder_B8Q5(condition_One,condition_Two,ss.getCcarType(),"02");
			list_ws = factory_ws.getStatByStartOrderEndOrder_B8Q5(condition_One,condition_Two,ss.getCcarType(),"02",con);
			sql_ws = dao.getStatByStartOrderEndOrder_B8Q5(condition_One,condition_Two,ss.getCcarType(),"02");
			...
			list_part = factory_ws.getPartsByStartTimeNum_B8Q5(condition_One,condition_Two,ss.getCcarType(),"02",con);
			sql_part = dao.getPartsByStartTimeNum_B8Q5(condition_One,condition_Two,ss.getCcarType(),"02");
			list_ws = factory_ws.getStatByStartTimeNum_B8Q5(condition_One,condition_Two,ss.getCcarType(),"02",con);
			sql_ws = dao.getStatByStartTimeNum_B8Q5(condition_One,condition_Two,ss.getCcarType(),"02");
			sql_temp3 = "where cx.dWBegin>=convert(varchar(100),'" + condition_One + "',20) ";
	    ...
	    ||radio_value==3&&request.getParameter("d13").equals("")&&request.getParameter("num").equals("")){
	    	list_part = factory_ws.getParts_B8Q5(ss.getCcarType(),"02",con);
	    	sql_part = dao.getParts_B8Q5(ss.getCcarType(),"02");
	    	list_ws = factory_ws.getStat_B8Q5(ss.getCcarType(),"02",con);
			sql_ws = dao.getStat_B8Q5(ss.getCcarType(),"02");
