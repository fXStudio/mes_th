...
<html>
	...
	<%   
    final  Log log = LogFactory.getLog("history_welding_q5.jsp");
	...
	try{
	    ...
	    switch(radio_value){
			...
			list_part = factory_ws.getHistoryPartsByStartTimeEndTime_B8Q5(condition_One,condition_Two,ss.getCcarType(),"01",con);
			sql_part = dao.getHistoryPartsByStartTimeEndTime_B8Q5(condition_One,condition_Two,ss.getCcarType(),"01");
			list_ws = factory_ws.getHistoryStatByStartTimeEndTime_B8Q5(condition_One,condition_Two,ss.getCcarType(),"01",con);
			sql_ws = dao.getHistoryStatByStartTimeEndTime_B8Q5(condition_One,condition_Two,ss.getCcarType(),"01");
			...
			list_part = factory_ws.getHistoryPartsByStartOrderEndOrder_B8Q5(condition_One,condition_Two,ss.getCcarType(),"01",con);
			sql_part = dao.getHistoryPartsByStartOrderEndOrder_B8Q5(condition_One,condition_Two,ss.getCcarType(),"01");
			list_ws = factory_ws.getHistoryStatByStartOrderEndOrder_B8Q5(condition_One,condition_Two,ss.getCcarType(),"01",con);
			sql_ws = dao.getHistoryStatByStartOrderEndOrder_B8Q5(condition_One,condition_Two,ss.getCcarType(),"01");
			...
			list_part = factory_ws.getHistoryPartsByStartTimeNum_B8Q5(condition_One,condition_Two,ss.getCcarType(),"01",con);
			sql_part = dao.getHistoryPartsByStartTimeNum_B8Q5(condition_One,condition_Two,ss.getCcarType(),"01");
			list_ws = factory_ws.getHistoryStatByStartTimeNum_B8Q5(condition_One,condition_Two,ss.getCcarType(),"01",con);
			sql_ws = dao.getHistoryStatByStartTimeNum_B8Q5(condition_One,condition_Two,ss.getCcarType(),"01");
			sql_temp3 = "where cx.dWBegin>=convert(varchar(100),'" + condition_One + "',20) ";
	    ...
	    ||radio_value==3&&request.getParameter("d13").equals("")&&request.getParameter("num").equals("")){
	    	list_part = factory_ws.getHistoryParts_B8Q5(ss.getCcarType(),"01",con);
	    	sql_part = dao.getHistoryParts_B8Q5(ss.getCcarType(),"01");
	    	list_ws = factory_ws.getHistoryStat_B8Q5(ss.getCcarType(),"01",con);
			sql_ws = dao.getHistoryStat_B8Q5(ss.getCcarType(),"01");
	...
	//	sql = "select * from cardata cd left join(";
		...
		sql = sql + " and substring(cseqno,1,2)='01'";
		sql = sql + sql_temp3;
...
.head2 {
	...
	<body background="../images/background.jpg">
		...
		<div class="title">
			<strong>
				<!-- InstanceBeginEditable name="标题2" -->Q5焊装查询统计<!-- InstanceEndEditable -->
			</strong>
		</div>
		<br>
		<div align="center">
			...
			<form action="history_welding_q5.jsp">
				<table>
					<tr>
						<td>
