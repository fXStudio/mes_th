...
<script>
<!-- 
alert("参数为空");window.location.href='process_servers_modify.jsp';
 -->
</script>
<%
		return;
...
<script>
<!-- 
alert("操作成功！");window.location.href='process_servers_view.jsp?page=<%=intpage%>&eid=<%=eid%>&process_info=<%=process_info%>';
 -->
</script>
<%
		}
