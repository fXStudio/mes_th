 function atCalendarControl(){
  ...
  this.addCalendarPad=function(){
   ...
   document.write("<iframe frameborder=0 height=167 width=255></iframe>");
  //document.write("<div style='position:absolute;top:4;left:4;width:248;height:164;background-color:#336699;'></div>");阴影
   document.write("</div>");
  ...
  this.addCalendarBoard=function(){
   ...
   divBoard.style.cssText="position:absolute;top:0;left:0;width:255;height:167;border:none;background-color:buttonface;";

   var tbBoard=document.createElement("table");
   divBoard.insertAdjacentElement("beforeEnd",tbBoard);
   tbBoard.style.cssText="position:absolute;top:0;left:0;width:100%;height:10;font-size:9pt;";//yd
   tbBoard.cellPadding=0;
   tbBoard.cellSpacing=0;
   tbBoard.bgColor="#f0f0f0";//边框颜色  

  /************** 设置各功能按钮的功能 *********************/
   /*********** Calendar About Button ***************/
   trRow = tbBoard.insertRow(0); 
   trRow.bgColor="#f0f0f0";
   trRow.align='right';
   trRow.style.border='none';
   ...
   tbCell.colSpan=5;
   tbCell.bgColor="#ffffee";//显示当前日期单元格
   tbCell.align="center";
   tbCell.style.cssText = "cursor:default;font-weight:bold;";
   calendar.head=tbCell;
   
   /*********** Calendar Close Button ***************/
   tbCell=trRow.insertCell(2);
   calendar.calendarClose = calendar.insertTbCell(trRow,2,"x","center");
   calendar.calendarClose.title="关 闭";
   ...
   for (var i = 0; i < 7; i++) {
    ...
    tbCell.align="center";
    tbCell.width=35;
	tbCell.style.cssText="cursor:default;border:none;background-color:#ffffff;font-weight:bold;";
   }
   ...
   tbCell.height=97;
   tbCell.vAlign="top";
   tbCell.bgColor="#ffffff";//日期单元格边框颜色
   var tbBody=document.createElement("table");
   tbCell.insertAdjacentElement("beforeEnd",tbBody);
   tbBody.style.cssText="position:relative;top:0;left:0;width:245;height:103;font-size:9pt;border:0px"//yd
  ...
  var btnCell=document.createElement("button");   
   ...
   btnCell.style.cssText="width:100%;border:1px;background-color:#ffffff;font-weight:bold;";//buttonface
   btnCell.onmouseover=function(){
    btnCell.style.cssText="width:100%;border:1px;border-color:'#ffffff';background-color:#f0f0f0;font-weight:bold;";
   }
   btnCell.onmouseout=function(){
    btnCell.style.cssText="width:100%;border:1px;border-color:'#ffffff';background-color:#ffffff;font-weight:bold;";//buttonface
   }
 ...
 // btnCell.onmousedown=function(){
  ...
  // }
   btnCell.onmouseup=function(){
    btnCell.style.cssText="width:100%;border:none;background-color:#f0f0f0;font-weight:bold;";
   }
   ...
   for(i=0;i<theRows;i++){
    ...
    for(j=0;j<7;j++){
     ...
     if(n>theFirstDay && n<=theMonthLen){
      ...
      theCell.style.cssText="background-color:#ffffff;cursor:default;padding:1px;border:none";//yd
     }
    }
   }
  ...
  this.insertBodyCell=function(theRow,j,day,targetObject){
   var theCell=theRow.insertCell(j);
   if(j==0) var theBgColor="#ffffff";//星期日
   else var theBgColor="#FFFFFF";//除了星期日和当前日
   if(day==calendar.currentDate[2]) var theBgColor="#FFFFFF";
   if(day==calendar.today[2]) var theBgColor="#ffffee";//当前
   theCell.bgColor=theBgColor;
   theCell.innerText=day;
   theCell.align="center";
   theCell.width=35;
   theCell.style.cssText="border:none #FFFFFF;cursor:hand;padding:1px";
   theCell.onmouseover=function(){ 
    theCell.bgColor="#f0f0f0"; 
    theCell.style.cssText="border:none;cursor:hand;padding:1px";
   }
  ...
  this.setup=function(defaultDate){
   ...
   //yd
   var tds = calendar.calendarPad.getElementsByTagName("td");
    var i=0;			 
	for(i=0;i<tds.length;i++){
		tds[i].style.padding="1px";
		tds[i].style.border='0px';
	}
  }
  /************** 关于AgetimeCalendar *********************/
  this.about=function(){
