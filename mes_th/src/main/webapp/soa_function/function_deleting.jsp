...
<script>
<!-- 
alert("参数为空");window.location.href='function_manage.jsp?page=<%=intpage%>&info=<%=info%>&eid=<%=functionid%>';
 -->
</script>
<%
		return;
...
<script>
<!-- 
alert("操作成功！");window.location.href='function_manage.jsp?page=<%=intpage%>&info=<%=info%>';
 -->
</script>
<%
		}
...
<script>
<!-- 
alert("操作失败！原因不明！请与管理员联系！");window.location.href='function_manage.jsp?page=<%=intpage%>&info=<%=info%>&eid=<%=functionid%>';
 -->
</script>
<%
			}
...
<script>
<!--  
alert("发生异常！<%=e.toString()%>");window.location.href='function_manage.jsp?page=<%=intpage%>&info=<%=info%>&eid=<%=functionid%>';
-->
</script>	
<%
	throw e;
