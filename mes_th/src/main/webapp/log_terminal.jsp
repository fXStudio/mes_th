...
<!-- 
     alert("参数为空!");window.location.href='index_terminal.jsp';
 -->
</script>
<%
		return;
...
<script language="JavaScript">
<!-- 
     alert("连接失效！");window.location.href='index_terminal.jsp';
 -->
</script>
<%
			return;
		...
		if(ac.userProof(username,password))
		{
			...
			String url="log4_terminal.jsp?year="+year+"&month="+month+"&day="+day;
...
<script language="JavaScript">
<!-- 
     alert("<%=message%>");window.location.href='index_terminal.jsp';
 -->
</script>
<%
			return;
