 function atCalendarControl(){
  ...
  /************** 设置各功能按钮的功能 *********************/
   ...
   tbCell.colSpan=5;
   tbCell.bgColor="#ffffff";//显示当前日期单元格
   tbCell.align="center";
   ...
   for (var i = 0; i < 7; i++) {
    ...
    tbCell.align="center";
    tbCell.width=35;
    //tbCell.style.cssText="cursor:default;border:1 solid #D4D4D4;background-color:#ffffff;font-weight:bold;";
  ...
  this.insertTbCell=function(trRow,cellIndex,TXT,trAlign,tbColSpan){
   ...
   btnCell.value=TXT;
   btnCell.style.cssText="width:100%;border:none;background-color:#ffffff;font-weight:bold;";//buttonface
  ...
  //alert("aaa");
   ...
   if(day==calendar.today[2]) var theBgColor="#F0F0F0";//当前
   theCell.bgColor=theBgColor;
   theCell.innerText=day;
   theCell.align="center";
   theCell.width=35;
   theCell.style.cssText="border:none #FFFFFF;cursor:hand;";
   theCell.onmouseover=function(){ 
    theCell.bgColor="#F0F0F0"; 
    theCell.style.cssText="border:none;cursor:hand;";
   }
